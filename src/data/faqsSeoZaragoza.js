export const schemaLocalZaragoza = {
  ...
  "@graph": [
        ...
        "itemListElement": [
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Diseño web para empresas de Zaragoza",
              "description": "Páginas web profesionales para empresas y negocios de Zaragoza",
              "areaServed": {
                "@type": "City",
                "name": "Zaragoza"
              }
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "Tiendas online Zaragoza",
              "description": "Desarrollo de ecommerce para comercios de Zaragoza",
              "areaServed": {
                "@type": "City",
                "name": "Zaragoza"
              }
          ...
          },
          {
            ...
            "itemOffered": {
              "@type": "Service",
              "name": "SEO local Zaragoza",
              "description": "Posicionamiento web para negocios locales de Zaragoza",
              "areaServed": {
                "@type": "City",
                "name": "Zaragoza"
              }
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "¿Trabajáis con empresas y autónomos de Zaragoza?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, trabajamos con empresas, autónomos, startups y profesionales independientes de Zaragoza y toda la provincia. Tenemos experiencia en diversos sectores como turismo, hostelería, comercio local, servicios profesionales y sector industrial característico de la zona."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "¿Ofrece AstracodeLAB mantenimiento web en Zaragoza?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Sí, ofrecemos planes de mantenimiento y soporte web para empresas de Zaragoza. Esto incluye actualizaciones de seguridad, copias de seguridad, resolución de incidencias y modificaciones de contenido. Puedes consultar nuestros planes desde la sección de Mantenimiento y Soporte."
          }
        },
        {
          "@type": "Question",
        ...
        {
          "@type": "Question",
          "name": "¿Incluye SEO local para aparecer en búsquedas de Zaragoza?",
          "acceptedAnswer": {
            "@type": "Answer",
